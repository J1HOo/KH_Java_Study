...
public class ScannerEx1 {
    ...
    */
        ...
        int num2 = sc.nextInt(); // 정수입력 2: 가 나온 다음 입력된 정수를 얻어와 num2 대입
        ...
        System.out.print("단어를 두 가지 입력하세요 : ");
        String 단어1 = sc.next();
        String 단어2 = sc.next();

        System.out.println("단어 두 가지 출력하기 : "  + 단어1 + 단어2);

    // - next() / nextInt() / nextDouble() 등을 작성한 이후 nextLine()을 작성 해야 하는 상황이 오면 nextLine() 구문을 미리 한 번 작성하기
    }
}
