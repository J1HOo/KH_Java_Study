...
public class ReturnPre2 {
    ...
    public String method2(int num1, int num2) {
        if (num1 > num2) {
            return num2 + " 보다 " + num1 + " 이 더 큰 수 입니다.";
        } else {
            return num1 + "보다" + num2 + "가 더 큰 수 입니다.";
        }
    }
    ...
    public String method4(double price, double discountRate) {
        ...
        return "원래 가격 : " + price + " 원 할인율 : " + discountRate + " % 최종금액 : " + totalPrice;
    }

    // 6. 주어진 나이가 성인인지 확인하고 메세지 반환, 삼항 연산자 사용
