...
public class PolymorphismEx {
    ...
    // 하나는 두 문자형끼리 더하기
		...
		매개변수 타입이 int -> String :  오버로딩 적용

        public void method1(int i, String str) {}
		매개변수 개수가 다름 int -> int, String : 오버로딩 적용

      	public void method1(int num) {}
	    매개변수 이름은 다르지만 타입과 개수가 기준과 동일 -> int 1개 : 오버로딩 불가능 (중복)

        public char method1(int point) {}
	    반환 타입만 다르고 매개변수는 기준 메서드와 동일 -> char int : 오버로딩 불가능 (에러)

        public void method1(int i, int k) {}
	    매개변수 개수가 다름 int 1개 -> int, int 2개 : 오버로딩 적용

        public void method1(int num, String string) {}
	    매개변수 이름은 다르지만 타입과 개수가 2번 메서드와 동일 : 오버로딩 불가능 (중복)

        public void method1(String str, int i) {}
	    매개변수 선언 순서가 다름 int, String -> String, int : 오버로딩 적용
         */
